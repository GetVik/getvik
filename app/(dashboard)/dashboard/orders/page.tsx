    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl px-2 font-light text-white">Orders</h1>
            ...
            <DashboardCard title="Recent Orders" className="overflow-hidden">
                ...
                {!isLoading && !isError && hasAnyData && (
                  ...
                  "
                                >
                                    {/* Product */}
                                    <div
                                        className="md:col-span-3 font-medium text-white truncate text-base md:text-sm mb-1 md:mb-0"
                                    ...
                                    <div className="md:col-span-2 flex justify-between items-center md:block">
                                        ...
                                        <div className="text-sm text-gray-300 truncate text-right md:text-left">
                                            <div className="truncate" title={order.buyerId?.name || ""}>
                        ...
                        <div className="mt-6 flex flex-col items-start justify-between gap-2 border-t border-gray-800 pt-4 text-xs text-gray-500 sm:flex-row sm:items-center">
                            <span>
                                ...
                                filtered order
                                {filteredOrders.length !== 1 ? "s" : ""} (total {orders.length}
                                ).
                            </span>
                        </div>
                    </div>
